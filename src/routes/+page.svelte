...
<div
  class="bg-[#FFE8E8] w-full h-[60vh] flex flex-col justify-center items-center"
>
  ...
  >
    Welcome to RetroPGF Hub
  </h1>
  <p class="flex flex-row justify-center text-lg p-2">
    Nominate, Get Ideas, and Discover
  </p>
