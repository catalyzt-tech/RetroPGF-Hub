...
<div class="flex flex-col bg-white">
  ...
  <div class="flex flex-col px-10 md:px-20 lg:px-52 overflow-hidden">
    ...
    <div class="flex justify-center items-center w-full overflow-hidden my-10">
      <img
        src="/img/retropgf2_banner_3.png"
        class="w-[70em] rounded-full"
        alt="retropgf1 "
      />
    </div>
    <section class="mb-3">
      ...
      <div class="mt-3">
        ...
        of <span class="font-medium">"impact = profit"</span>. By funding public
      ...
      <div class="flex justify-center items-center w-full my-2 overflow-hidden">
        <img src="/img/Bicameral.webp" alt="bicameral" class="w-[60em]" />
      </div>
    </section>
    <section class="mb-3">
      ...
      <div>
        ...
        >
          ...
          <li class="mb-6 ml-6">
            ...
            <p class="text-gray-600">
              Anyone could nominate a project on <a
                href="https://gov.optimism.io/t/nominations-for-retropgf2/4636"
                target="_blank"
                class="text-[#ff1818] hover:underline">the forum</a
              > by providing a name, impact description and link to Github/Twitter.
            </p>
          </li>
          <li class="mb-6 ml-6">
            <div
            ...
            <p class="text-gray-600">
              ...
              <a href="/archive" class="text-[#ff1818] hover:underline"
                >archive page</a
              >.
            </p>
          </li>
          <li class="mb-6 ml-6">
            ...
            <div class="text-md font-medium">Voting</div>
            <p class="text-gray-600">
              Badgeholders were provided with a <a
                ...
                class="text-[#ff1818] hover:underline">badgeholder manual</a
              >
              ...
              <a
                ...
                class="text-[#ff1818] hover:underline">voting form</a
              >
            </p>
          </li>
          <li class="ml-6">
    ...
    <section class="mb-3">
      ...
      >
        <img
          src="/img/retropgf2_banner_3.jpeg"
    ...
    <section class="mb-3">
      ...
      <div class="text-lg font-semibold my-4">For people or projects</div>
      <ol class="list-disc ml-5">
        <li>
          <div class="font-medium">Read the Project Manual</div>
          <p class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Opt-In and Create a Project Profile</div>
          <p class="text-gray-600">
      ...
      <div class="text-lg font-semibold my-4">Nominate Template</div>
      <p>
      ...
      <div class="bg-[#FFE8E8] py-5 px-8 my-5 rounded-xl">
        <div class="font-medium mb-2">For people or projects</div>
        <ol class="list-disc ml-5">
          <li>
        ...
        <div class="font-medium mt-3 mb-2">For collections</div>
        <p>
    ...
    <section class="mb-3">
      ...
      <ol class="list-disc ml-5 my-5">
        <li>
          ...
          <p class="text-gray-600">
            We welcomed back 14 badgeholders who had previously <a
              target="_blank"
              class="text-[#ff1818] hover:underline"
              href="https://docs.google.com/spreadsheets/d/1g4ilAByMNQsmlBC8cskQip7Ojd_qK6IhozJCyoVfU9k/edit#gid=0"
              >participated in Round 1</a
            > of RetroPGF. Their experience and insights from the first round make
        ...
        <li>
          ...
          <p class="text-gray-600">
            10 badgeholders were <a
              target="_blank"
              class="text-[#ff1818] hover:underline"
              href="https://snapshot.org/#/opcollective.eth/proposal/0x22d4c3ab56832de58c1774d1a0aeb61ba6dde8b16c0f8382f85d8935f3ee1f11"
              >elected by Optimism's Token House</a
            > , adding a democratic element to the selection process. One voting
      ...
      <div class="bg-[#FFE8E8] py-1 px-8 my-5 rounded-xl">
        <ol class="list-disc ml-5 my-5">
          <li>
      ...
      <div class="text-lg font-semibold my-4">Things to aware</div>
      <div>
      ...
      <div class="bg-[#FFE8E8] py-1 px-8 my-5 rounded-xl">
        <ol class="list-disc ml-5 my-5 text-gray-600">
          ...
          <li>
            Badgeholders are expected to adhere to the Optimism Delegate <a
              target="_blank"
              class="text-[#ff1818] hover:underline"
              href="https://gov.optimism.io/t/code-of-conduct"
              >Code of Conduct</a
            >.
          </li>
          <li>
    ...
    <section class="mb-3">
      ...
      <div>
        See the full list of all RetroPGF 2 recipients with details through <a
          href="/archive"
          class="text-[#ff1818] hover:underline">archive page</a
        >, or through the sheet
        <a
          href="https://optimism.mirror.xyz/7v1DehEY3dpRcYFhqWrVNc9Qj94H2L976LKlWH1FX-8"
          target="_blank"
          class="text-[#ff1818] hover:underline">here</a
        >.
      </div>
      ...
      <div class="text-lg font-semibold my-4">Tooling & Utilities</div>
      <div>
      ...
      <div class="text-lg font-semibold my-4">Educations</div>
      <div>
      ...
      <div>
        ...
        >, there was relatively low variance among the funded projects, with
    ...
    <section class="mb-3">
      ...
      <ol class="list-disc ml-5 my-5">
        ...
        <li>
          <div class="font-medium">Project Nominations</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Project Intake Form:</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Unclear Information & States</div>
          <div class="text-gray-600">
          ...
          <div class="px-8 my-5 rounded-xl">
            <div class="italic text-[#ff1818]">
              ...
              is their funding situation like,” <span class="text-black"
                >- Anonymous.</span
              >
            </div>
            <div class="italic text-[#ff1818]">
              “The application form for next season should be more aligned with
              the review assessment process,” <span class="text-black"
                >- Krzysztof Urbanski.</span
              >
            </div>
            <div class="italic text-[#ff1818]">
              ...
              being the main one),” <span class="text-black">- Cassidy.</span>
            </div>
          </div>
        </li>
        <li>
          <div class="font-medium">Project Profiles</div>
          <div class="text-gray-600">
      ...
      <div class="text-lg font-semibold my-4">Scaling Impact Evaluation</div>
      <div>
      ...
      <ol class="list-disc ml-5">
        ...
        <li>
          <div class="font-medium">Introducing "Collections"</div>
          <div class="text-gray-600">
      ...
      <div class="text-lg font-semibold my-4">Badgeholders Collaboration</div>
      <div>
        ...
        guidance through a <a
          class="text-[#ff1818] hover:underline"
          target="_blank"
          href="https://www.notion.so/11ef6cd63c254258a32246289f45925c"
          >badgeholder manual</a
        >
        and
        <a
          class="text-[#ff1818] hover:underline"
          target="_blank"
          href="https://www.youtube.com/watch?t=5&v=ylog569SjMI&feature=youtu.be"
          >onboarding calls</a
        >.
      </div>
      <ol class="list-disc ml-5">
        ...
        <li>
          <div class="font-medium">Emphasis on Collaboration</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">The Impact of Collaborative Calls</div>
          <div class="text-gray-600">
      ...
      <ol class="list-disc ml-5">
        ...
        <li>
          <div class="font-medium">Seeking Clarity in Evaluation</div>
          <div class="px-8 my-5 rounded-xl">
            <div class="italic text-[#ff1818]">
        ...
        <li>
          <div class="font-medium">The Dilemma of Future Impact</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Addressing the Challenges</div>
          <div class="px-8 my-5 rounded-xl">
            <div class="italic text-[#ff1818]">
      ...
      <ol class="list-disc ml-5">
        ...
        <li>
          <div class="font-medium">Resourcefulness Amidst Challenges</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">A Call for Better Voting Tooling</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Questions for Improvement</div>
          <div class="px-8 my-5 rounded-xl">
            <div class="italic text-[#ff1818]">
    ...
    <section class="mb-3">
      <div class="text-3xl font-bold italic">The Next Journey</div>
      <div class="mt-3">
      ...
      >
        <img
          src="/img/retropgf2_journey.jpeg"
          class="w-[50em] rounded-full"
          alt="retropgf1"
        />
      </div>
