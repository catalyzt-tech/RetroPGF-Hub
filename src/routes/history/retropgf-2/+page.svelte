      ...
      <div>
        ...
        >
          ...
          <li class="mb-6 ml-6">
            ...
            <p class="text-gray-600">
              anyone could nominate a project on the forum (opens new window) by
              providing a name, impact description and link to Github/Twitter
            </p>
          </li>
          <li class="mb-6 ml-6">
            <div
            ...
            <p class="text-gray-600">
              Projects had to create a profile (opens new window) where they
              were asked for general information, as well as a description of
              their project and its impact. Information provided by Projects can
              be viewed on the RetroPGF discovery page (opens new window).
            </p>
          </li>
          <li class="mb-6 ml-6">
            <div
            ...
            <p class="text-gray-600">
              ...
              window) and asked to evaluate and vote on nominated projects via a
              voting form
            </p>
          </li>
          <li class="ml-6">
