  ...
  <div class="flex flex-col px-10 md:px-20 lg:px-52 overflow-hidden">
    ...
    <section>
      ...
      <div class="mt-3">
        ...
        public, read-only Discord channel named <span class="italic"
          >#retroactive-public-goods</span
    ...
    <section class="mb-5">
      ...
      <div>
        ...
        >. For Vitalik's review of the round,
        <a
          href="https://vitalik.ca/general/2021/11/16/retro1.html"
          class="text-[#ff1818] hover:underline">click here.</a
        >
      </div>
    </section>
    <section class="mb-5">
