<div class="flex flex-col bg-white">
  <div class="w-screen h-64 overflow-hidden">
    <img src="/img/retropgf3_banner.jpg" class="w-full" alt="retropgf3" />
  </div>
  <div class="flex flex-col px-10 md:px-20 lg:px-52 overflow-hidden">
    ...
    <div class="flex justify-center items-center w-full overflow-hidden my-10">
      <img
        src="/img/retropgf3_banner_2.webp"
    ...
    <section class="mb-3">
      ...
      >
        <img
          src="/img/retropgf3_banner_2.png"
          class="w-[50em] rounded-full"
          alt="retropgf1"
        />
      </div>
      ...
      <div>
        ...
        >
          ...
          <li class="mb-6 ml-6">
            ...
            <div class="text-md font-medium">Results & Token Disbursement</div>
            <p class="text-gray-600">
    ...
    <section class="mb-3">
      <div class="text-3xl font-bold italic">Scope of Round 3</div>
      <div class="mt-3">
      ...
      <ol class="list-disc ml-5 my-5">
        <li>
          <div class="font-medium">OP Stack</div>
        ...
        <li>
          <div class="font-medium">Collective Governance</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Developer Ecosystem</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">End User Experience & Adoption</div>
          <div class="text-gray-600">
    ...
    <section class="mb-3">
      <div class="text-3xl font-bold italic">Round Design</div>
      <div class="mt-3">
      ...
      >
        ...
        >
          ...
          <span class="font-medium text-lg">RetroPGF Sign up</span>
          <div class="mt-2">Gathering the right data from Projects</div>
        </div>
        <div
          class="flex-grow mt-4 lg:mr-8 border-2 border-black px-6 py-4 rounded-xl hover:bg-[#ff1818] hover:text-white hover:border-[#ff1818] transition ease-in-out duration-300"
        >
          <div class="text-4xl">✨</div>
          <span class="font-medium text-lg">Lists Application</span>
          <div class="mt-2">Scaling the Evaluation of Projects</div>
        </div>
        <div
          class="flex-grow mt-4 lg:mr-8 border-2 border-black px-6 py-4 rounded-xl hover:bg-[#ff1818] hover:text-white hover:border-[#ff1818] transition ease-in-out duration-300"
        >
          <div class="text-4xl">🤔</div>
          <span class="font-medium text-lg">Impact Evaluation</span>
          <div class="mt-2">Frameworks & Definitions</div>
        </div>
        <div
          class="flex-grow mt-4 lg:mr-8 border-2 border-black px-6 py-4 rounded-xl hover:bg-[#ff1818] hover:text-white hover:border-[#ff1818] transition ease-in-out duration-300"
        >
          <div class="text-4xl">🗳️</div>
          <span class="font-medium text-lg">Voting Application</span>
          <div class="mt-2">How badgeholders express themselves</div>
        </div>
      </div>
      ...
      <ol class="list-disc ml-5 my-5">
        <li>
          <div class="font-medium">More Detailed Questions</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Standardized Data Sources</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Self-Reported Impact Metrics</div>
          <div class="text-gray-600">
      ...
      <div class="text-lg font-semibold my-4">Lists Application</div>
      <div>
      ...
      >
        <img
          src="/img/retropgf3_design_2.jpg"
          class="w-[60em] rounded-lg"
          alt="Lists"
        />
      </div>
      ...
      <ol class="list-disc ml-5 my-5">
        <li>
          <div class="font-medium">Knowledge Sharing</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Collaboration Made Easy</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Methodology Matters</div>
          <div class="text-gray-600">
      ...
      <div class="text-lg font-semibold my-4">Impact Evaluation</div>
      <div>
      ...
      <ol class="list-disc ml-5 my-5">
        <li>
          <div class="font-medium">Clearer Roles</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Impact Evaluation Frameworks</div>
          <div class="text-gray-600">
      ...
      <div class="text-lg font-semibold my-4">Voting Application</div>
      <div>
      ...
      >
        <img
          src="/img/retropgf3_design_3.png"
          class="w-[60em] rounded-lg"
          alt="Lists"
        />
      </div>
      <ol class="list-disc ml-5 my-5">
        <li>
          <div class="font-medium">All-in-One Application</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Integration Made Easy</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Role-Aligned Design</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Flexible Voting Power</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Project Allocation</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Results You Can Trust</div>
          <div class="text-gray-600">
        ...
        <li>
          <div class="font-medium">Privacy Matters</div>
          <div class="text-gray-600">
    ...
    <section class="mb-3">
      <div class="text-3xl font-bold italic">More Tooling</div>
      <div class="mt-3">
      ...
      <div class="bg-[#FFE8E8] py-5 px-8 my-5 rounded-xl">
        ...
        <div>
          But that's not all! Our community is buzzing with additional tools and
          experiments:
        </div>
        <ol class="list-disc ml-5 my-5">
          <li>
