...
export default function ProjectFeedBackCard({
  ...
  return (
    <div
      className={`flex flex-col gap-4 border rounded-lg p-3 lg:p-6 max-[300px]:min-h-[300px]  ${background}`}
    >
      ...
      <p className="text-base font-normal text-gray-600 line-clamp-2 mb-2 sm:mb-4">
        {description}
      </p>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          >
            {favOrNot ? (
              ...
              <Favorite
                size={24}
                className="group-hover:fill-primaryRed fill-gray-800"
              />
            )}
