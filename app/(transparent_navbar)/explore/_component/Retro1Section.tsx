  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="relative">
        ...
        {!state.start && (
          <button
            className="hidden md:block absolute top-1/2 transform -translate-y-1/2 -left-4 md:-left-6 cursor-pointer z-50"
        ...
        {!state.end && (
          <button
            className="hidden md:block absolute top-1/2 transform -translate-y-1/2 -right-4 md:-right-6 cursor-pointer z-50"
    ...
    <div className="flex flex-col gap-2 flex-grow-1 flex-shrink-0 border rounded-lg shadow-sm h-[14rem] w-[14.25rem] relative mx-3">
      <div className="p-4 flex flex-col justify-start items-start gap-3">
        <div className="flex flex-col gap-0.5">
          <Link
            href={'/explore'}
            className="text-sm font-bold text-gray-800 z-30 hover:underline"
          >
            L2BEAT
          </Link>
