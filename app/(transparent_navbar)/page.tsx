        ...
        <div className="bg-gradient-to-br from-[#FFFEEA] to-100% via-[#FFDAAF] to-[#FFAB9F] w-full absolute -top-[4.5rem] left-0 h-screen">
          <div className="px-4 lg:px-0 flex flex-col justify-center items-center font-rubik w-full h-full">
            <div className="flex flex-col items-center justify-center text-center gap-4">
              <span className="text-3xl sm:text-5xl lg:text-6xl font-semibold text-gray-900">Explore Ideas</span>
              <span className="text-3xl sm:text-5xl lg:text-6xl font-semibold text-gray-900">Build Project</span>
              <span className="text-3xl sm:text-5xl lg:text-6xl font-semibold text-gray-900">Create Impact</span>
            </div>
