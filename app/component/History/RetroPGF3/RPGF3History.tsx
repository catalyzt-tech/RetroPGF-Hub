...
const RPGF3History: FC = () => {
  ...
  const toolingRef = useRef<HTMLElement | null>(null);
  ...
  return (
    ...
    <div className="col-span-7 lg:col-span-5 flex flex-col gap-10">
      <section className="" id="RetroPGF 3" ref={introRef}>
      ...
      <section className="" id="Round Design" ref={designRef}>
      ...
      <section className="" id="Tooling" ref={toolingRef}>
