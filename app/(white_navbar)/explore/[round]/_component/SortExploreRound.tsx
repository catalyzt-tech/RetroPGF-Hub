                ...
                <div>
                    <Menu.Button className="">
                        <div
                            ...
                            `}
                        >
                            <SortAscending size={24} className="fill-gray-500 group-hover:fill-red-500" />
                            <p className=" text-sm font-normal self-center text-gray-600 group-hover:text-red-500">{state.sort}</p>
                        </div>
                    </Menu.Button>
                </div>
                        ...
                        <div className="mt-4">
                            {sorting.map((item, i) => (
                                <Menu.Item key={i}>
                                    {({ active }) => (
                                        <button
                                            className={`${state.sort === item.name ? 'bg-gray-100 hover:bg-gray-200' : 'text-gray-900'
