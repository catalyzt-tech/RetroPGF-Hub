...
import RetroPGF2 from '@/public/static/rpgf2.json'

export default function Cpage({ round2 }: { round2: RetroRound2[] }) {
        ...
        <Tab.Panels>
          ...
          <Tab.Panel className="outline-none min-h-[70vh]">
            <Transition
              ...
              leaveTo="transform scale-95 opacity-0"
            >
              <StatisticSection data={RetroPGF2} round={2} />
            </Transition>
          </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
