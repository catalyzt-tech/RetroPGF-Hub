...
export default function ProjectTab({
    ...
    const filterJson = useMemo(() => {
        ...
        return round1.filter((item) => {
            ...
            search !== ''
                ? typeof(item["Project Name"]) === "string" && item["Project Name"].toLowerCase().includes(search.toLowerCase())
                    : true
            ...
            let recieveOP:boolean =  item.allocation >= minVal && item.allocation <= maxVal;;
