...
import RetroPGF3 from '@/public/static/rpgf3.json'
export default function Cpage({ round3 }: { round3: RetroRound3[] }) {
        ...
        <Tab.Panels>
          ...
          <Tab.Panel className="outline-none min-h-[70vh]">
            <Transition
              ...
              leaveTo="transform scale-95 opacity-0"
            >
              <StatisticSection data={RetroPGF3} round={3} />
            </Transition>
          </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
